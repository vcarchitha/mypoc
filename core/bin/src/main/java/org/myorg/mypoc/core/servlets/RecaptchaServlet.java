...
String gRecaptchaResponse = request.getParameter("path");
String status = RequestHandler.verifyResponse(gRecaptchaResponse) ? "success" : "failure";
                	logger.info("recaptcha::::::::::"+gRecaptchaResponse);
                	try {
